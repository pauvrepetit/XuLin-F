...
module kernel_bc_kernel_bc_pe_2_Pipeline_VITIS_LOOP_69_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] hbm2_addr_read_reg_323;
reg    ap_block_pp0_stage71_11001;
wire   [2:0] add_ln71_8_fu_213_p2;
reg   [2:0] add_ln71_8_reg_328;
reg   [63:0] hbm2_addr_1_reg_333;
...
wire   [5:0] shl_ln71_8_fu_218_p3;
wire   [63:0] zext_ln71_8_fu_225_p1;
wire   [63:0] lshr_ln71_fu_229_p2;
wire   [31:0] trunc_ln72_fu_234_p1;
wire   [34:0] shl_ln8_fu_238_p3;
wire   [63:0] zext_ln72_fu_246_p1;
wire   [63:0] add_ln72_fu_250_p2;
wire   [60:0] trunc_ln8_fu_255_p4;
...
kernel_bc_dadd_64ns_64ns_64_6_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dadd_64ns_64ns_64_6_no_dsp_1_U81(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_134_p0),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage71_11001) & (icmp_ln69_reg_303 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage71))) begin
        add_ln71_8_reg_328 <= add_ln71_8_fu_213_p2;
        hbm2_addr_read_reg_323 <= m_axi_hbm2_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage72_11001) & (icmp_ln69_reg_303 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage72))) begin
        hbm2_addr_1_reg_333 <= sext_ln72_fu_265_p1;
    end
end
...
always @ (*) begin
    if (((icmp_ln69_reg_303 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        if (((1'b0 == ap_block_pp0_stage72_11001) & (1'b1 == ap_CS_fsm_pp0_stage72))) begin
            m_axi_hbm2_ARADDR = sext_ln72_fu_265_p1;
        end else if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            m_axi_hbm2_ARADDR = sext_ln71_fu_196_p1;
        end else begin
...
assign add_ln69_fu_153_p2 = (ap_sig_allocacmp_i_9 + 32'd1);

assign add_ln71_8_fu_213_p2 = (trunc_ln71_s_fu_206_p3 + trunc_ln);
...
always @ (*) begin
    ap_block_pp0_stage142_11001 = ((icmp_ln69_reg_303 == 1'd0) & (m_axi_hbm2_RVALID == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage142_subdone = ((icmp_ln69_reg_303 == 1'd0) & (m_axi_hbm2_RVALID == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end
...
always @ (*) begin
    ap_block_pp0_stage2_11001 = ((m_axi_hbm2_AWREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage2_subdone = ((m_axi_hbm2_AWREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_pp0_stage3_11001 = ((m_axi_hbm2_WREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage3_subdone = ((m_axi_hbm2_WREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_pp0_stage71_11001 = (((m_axi_hbm2_BVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln69_reg_303 == 1'd0) & (m_axi_hbm2_RVALID == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage71_subdone = (((m_axi_hbm2_BVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln69_reg_303 == 1'd0) & (m_axi_hbm2_RVALID == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state143_pp0_stage142_iter0 = ((icmp_ln69_reg_303 == 1'd0) & (m_axi_hbm2_RVALID == 1'b0));
end
...
always @ (*) begin
    ap_block_state216_pp0_stage71_iter1 = (m_axi_hbm2_BVALID == 1'b0);
end
...
always @ (*) begin
    ap_block_state2_io = ((icmp_ln69_reg_303 == 1'd0) & (m_axi_hbm2_ARREADY == 1'b0));
end
...
always @ (*) begin
    ap_block_state72_pp0_stage71_iter0 = ((icmp_ln69_reg_303 == 1'd0) & (m_axi_hbm2_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state73_io = ((icmp_ln69_reg_303 == 1'd0) & (m_axi_hbm2_ARREADY == 1'b0));
end
...
assign grp_fu_134_p0 = m_axi_hbm2_RDATA;

assign icmp_ln69_fu_147_p2 = ((ap_sig_allocacmp_i_9 == to_process_count) ? 1'b1 : 1'b0);

assign lshr_ln71_fu_229_p2 = hbm2_addr_read_reg_323 >> zext_ln71_8_fu_225_p1;
...
assign m_axi_hbm2_AWADDR = hbm2_addr_1_reg_333;
...
assign m_axi_hbm2_WDATA = grp_fu_134_p2;

assign m_axi_hbm2_WID = 1'd0;

assign m_axi_hbm2_WLAST = 1'b0;

assign m_axi_hbm2_WSTRB = 8'd255;

assign m_axi_hbm2_WUSER = 1'd0;

assign sext_ln71_fu_196_p1 = $signed(trunc_ln71_5_reg_312);

assign sext_ln72_fu_265_p1 = $signed(trunc_ln8_fu_255_p4);

assign shl_ln71_8_fu_218_p3 = {{add_ln71_8_reg_328}, {3'd0}};

assign shl_ln8_fu_238_p3 = {{trunc_ln72_fu_234_p1}, {3'd0}};

assign shl_ln_fu_159_p3 = {{ap_sig_allocacmp_i_9}, {2'd0}};

assign trunc_ln71_fu_171_p1 = ap_sig_allocacmp_i_9[0:0];

assign trunc_ln71_s_fu_206_p3 = {{trunc_ln71_reg_307}, {2'd0}};

assign trunc_ln72_fu_234_p1 = lshr_ln71_fu_229_p2[31:0];

assign trunc_ln8_fu_255_p4 = {{add_ln72_fu_250_p2[63:3]}};

assign zext_ln71_8_fu_225_p1 = shl_ln71_8_fu_218_p3;

assign zext_ln71_fu_167_p1 = shl_ln_fu_159_p3;

assign zext_ln72_fu_246_p1 = shl_ln8_fu_238_p3;

endmodule //kernel_bc_kernel_bc_pe_2_Pipeline_VITIS_LOOP_69_1
